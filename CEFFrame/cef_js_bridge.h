...
namespace my_cef{
	...
	//typedef std::function<void (const std::string& params, ...)> CppFunction2;
	...
	typedef std::map<std::pair<CefString/* function_name*/, int/* frame_id*/>, CefRefPtr<CefV8Value>/* function*/> RenderRegisteredFunction;
