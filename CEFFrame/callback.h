...
class EXPORT_API SupportWeakCallback
{
public:
...
//class EXPORT_API WeakCallbackFlag final : public SupportWeakCallback
class EXPORT_API WeakCallbackFlag : public SupportWeakCallback
{
public:
	void Cancel()
	{
...
auto Bind(R(C::*f)(DArgs...) const, P && p, Args && ... args)->WeakCallback<decltype(std::bind(f, p, args...))>
{
	...
	static_assert(std::is_base_of<mynbase::SupportWeakCallback, C>::value, "mynbase::SupportWeakCallback should be base of C");
